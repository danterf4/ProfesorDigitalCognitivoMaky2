...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Diseño de Software", "Proyecto 1", "Profesor Digital Cognitivo"],    /* You can change the home section typing text from
		 ...
		 $(window).load(function(){
        $(".typingBegin").typed({
            strings: ["Inicio de Sesion"],    /* You can change the home section typing text from
	                                                                                            here and do not use "&" use "and" */
            typeSpeed: 50
          });
         });
